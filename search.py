...
def subestimated_branch_and_bound_tree_search(problem):
...
def graph_search(problem, fringe):
    ...
    while fringe:
        ...
        if node.state not in closed:
            ...
            expansion_list = node.expand(problem)
            expansion += 1
            print "Nodo expandido / Coste acumulado : ", node.state, "/", node.path_cost
            #print "Coste acumulado: ", node.path_cost
            #print "Coste heuristico : ", problem.h(node)
            fringe.extend(expansion_list)
    return None, expansion
...
# TODO: COMIENZO - Esto es mio -
def branch_and_bound_graph_search(problem):
    return graph_search(problem, PriorityQueue(f=lambda x: x.path_cost))

#def depth_sorted_graph_search(problem):
#    return graph_search(problem, SortedStack())

def subestimated_branch_and_bound_graph_search(problem):
    return graph_search(problem, PriorityQueue(f=lambda x: x.path_cost + problem.h(x)))

#def depth_heuristic_graph_search(problem):
#    return graph_search(problem, HeuristicStack(problem))
# TODO: FIN - Esto es mio -
