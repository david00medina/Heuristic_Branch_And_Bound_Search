...
#TODO: Reverse o no reverse? He ahi la cuestion...
#TODO:  Con reverse es exactamente igual que el SortedFIFOQueue
class SortedStack(Queue):
    """A sorted Last-In-First-Out Queue."""
...
class HeuristicFIFOQueue(Queue):
    """A sorted First-In-First-Out Queue."""
...
class HeuristicStack(Queue):
    """An heuristic approach to Last-In-First-Out Queue."""
